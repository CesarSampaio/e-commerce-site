...
<i class="fa fa-money fa-fw" ></i> Novas Ordens
</h3><!-- panel-title Ends -->
</div><!-- panel-heading Ends -->
...
<th> Código da ordem de pagamento: </th>
<th> Total: </th>
<th> Data: </th>
<th> Status: </th>
</tr>
...
<a href="index.php?view_orders" >
Ver Todas As Ordems <i class="fa fa-arrow-circle-right" ></i>
</a>
</div><!-- text-right Ends -->
</div><!-- panel-body Ends -->
</div><!-- panel panel-primary Ends -->
...
<i class="fa fa-user"></i> <span>Contato: </span> <?php echo $admin_contact; ?>   <br>
