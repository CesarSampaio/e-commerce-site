...
?>
        <div class="row"><!-- 1 row Starts -->
            <div class="col-lg-12"><!-- col-lg-12 Starts -->
                <ol class="breadcrumb"><!-- breadcrumb Starts -->
                    <li>
                        <i class="fa fa-dashboard"></i> Painel de Controle / Inserir categoria de Produto
                    </li>
                </ol><!-- breadcrumb Ends -->
            </div><!-- col-lg-12 Ends -->
        </div><!-- 1 row Ends -->
                    ...
                    <div class="panel-body" ><!-- panel-body Starts -->
                        <form class="form-horizontal" action="" method="post" enctype="multipart/form-data" ><!-- form-horizontal Starts -->
                            ...
                            <div class="form-group" ><!-- form-group Starts -->
                                ...
                                <div class="col-md-6" >
                                    <input type="submit" name="submit" value="Inserir" class="btn btn-primary form-control" >
                                </div>
                            </div><!-- form-group Ends -->
    ...
    <?php
        if(isset($_POST['submit'])){
            ...
            if($run_p_cat){
                echo "<script>alert('Nova categoria de Produto Inserida')</script>";
