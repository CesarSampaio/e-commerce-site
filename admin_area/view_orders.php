...
<li class="active">
<i class="fa fa-dashboard"></i> Dashboard / Ver Ordens
</li>
</ol><!-- breadcrumb Ends  --->
</div><!-- col-lg-12 Ends -->
</div><!-- 1 row Ends -->
...
<i class="fa fa-money fa-fw"></i> Ver Ordens
</h3><!-- panel-title Ends -->
...
$billing_address_2 = $row_order_addresses["billing_zone"];
$billing_state = $row_order_addresses["billing_complement"];
$billing_number = $row_order_addresses["billing_number"];
...
$shipping_address_2 = $row_order_addresses["shipping_zone"];
$shipping_address_2 = $row_order_addresses["shipping_complement"];
$shipping_state = $row_order_addresses["shipping_number"];
...
<td bgcolor="yellow">#<?php echo $order_date; ?></td>
<td>
<strong> R$ <?php echo $order_total; ?> </strong><br>
</td>
<td>
<?php 
