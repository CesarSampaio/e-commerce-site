    ...
    ?>
            <div class="col-md-12"><!-- col-md-12 Starts -->
                <div class="box text-center"><!-- box text-center Starts -->
                    <p class="lead"> Seu Carrinho está vazio. Impossível finalizar pedido. </p>
                    <a href="shop.php" class="btn btn-primary btn-lg"> Voltar à Loja </a>
    ...
    ?>
            <div class="col-md-8"><!-- col-md-8 Starts -->
                <div class="box"><!-- box Starts -->
                    <p class="lead"> Checar informações de pedido e pagamento. </p>
                    <?php
                    ...
                    <form method="post" id="shipping-billing-details-form"><!-- shipping-billing-details-form Starts -->
                        ...
                        <div class="form-group"><!-- form-group Starts -->
                            <label> Endereço 2 (optional): </label>
                        ...
                        <?php
                            if(count($physical_products) > 0) { ?>
                                <hr>
                                <div class="form-group"><!-- form-group Starts -->
                                    <h4> O Endereço de Envio é o Mesmo?</h4>
                                    <?php
                ...
                <div class="col-md-4"><!-- col-md-4 Starts -->
                    <div class="box" id="order-summary"><!-- box Starts -->
                        ...
                        <table class="table"><!-- table Starts -->
                            <thead>
                                <tr>
                                    <th class="text-muted lead"> Produto: </th>
                            ...
                            <tbody id="checkout-tbody-reload"><!-- tbody Starts -->
                                ...
                                ?>
                                <tr>
                                    <td class="text-muted bold"> Subtotal do Pedido </td>
                                                            ...
                                                            if(@$_SESSION["is_shipping_address_same"] == "yes"){
                                                                if(empty($billing_country) and empty($billing_postcode)){
                                                                    echo "
                                                                        <li>
                                                                        <p>
                                                                        Não há opções de frete disponíveis. Por favor cheque seu endereço novamente ou contate-nos se precisar de ajuda.
                                                                        </p>
                                                                        </li>
                                                                        ";
                                                                }
                                    ...
                                    <tr>
                                        <th colspan="2">
                                           <input id="offline-radio" type="radio" name="payment_method" value="pay_offline">
                                            <label for="offline-radio"> Pagamento por Boleto / Transferência </label>
                                            <p id="offline-desc" class="text-muted">
                                                Seu pedido será enviado após confirmação bancária do pagamento
                                            </p>
                                        </th>
                                    </tr>
                                    <tr>
                                        <th colspan="2">
                                            ...
                                            <label for="stripe-radio"> Cartão de Crédito </label>
                                    ...
                                    <tr>
                                        <th colspan="2">
                                            ...
                                            <p id="paypal-desc" class="text-muted">
                                                Pague via PayPal. Você pode pagar com seu cartão de crédito se você não tiver uma conta Paypal.
                                            </p>
                                        </th>
                                    </tr>
                                    <tr>
